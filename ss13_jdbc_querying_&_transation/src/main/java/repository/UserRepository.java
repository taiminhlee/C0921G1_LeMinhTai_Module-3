...
public class UserRepository implements UserRepositoryImpl {
    ...
    public List<User> selectUserByCountry(String country) {
        ...
        // Step 1: Establishing a Connection
        try {
            PreparedStatement preparedStatement = BaseRepository.connection.prepareStatement(SELECT_USER_BY_COUNTRY);
    ...
    public List<User> sortByName() {
        ...
        // Step 1: Establishing a Connection
        try {
            PreparedStatement preparedStatement = BaseRepository.connection.prepareStatement(SORT_BY_NAME);
    ...
    public void insertUpdateWithoutTransaction() {
        try (
                ...
                PreparedStatement psInsert = BaseRepository.connection.prepareStatement(SQL_INSERT);

                PreparedStatement psUpdate = BaseRepository.connection.prepareStatement(SQL_UPDATE)) {
...
//            conn = getConnection();
    ...
    public void insertUpdateUseTransaction() {
        ...
        try (
            ...
            BaseRepository.connection.setAutoCommit(false); // default true
...
//            psUpdate.setBigDecimal(2, new BigDecimal(999.99));
            ...
            BaseRepository.connection.setAutoCommit(true);
    ...
    public List<User> selectAllUsersTransaction() {
        ...
        try {
            CallableStatement callableStatement =
                    BaseRepository.connection.prepareCall("call display()");
            System.out.println(callableStatement);
    ...
    public boolean updateUserTransaction(User user) throws SQLException {
        boolean rowUpdated;
        try (CallableStatement statement = BaseRepository.connection.prepareCall("call edit(?,?,?,?);")) {
    ...
    public boolean deleteUserTransaction(int id) throws SQLException {
        boolean rowDeleted;
        try (CallableStatement statement = BaseRepository.connection.prepareCall("call `delete`(?);")) {
            statement.setInt(1, id);
            rowDeleted = statement.executeUpdate() > 0;
        }
        return rowDeleted;
